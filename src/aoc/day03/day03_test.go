...
func TestFuel(t *testing.T) {
	for _, tc := range testCases {
		...
		if got != tc.expected {
			t.Errorf("dummy(%s) = %d, want %d;", tc.wire1, got, tc.expected)
		}
	}
}
